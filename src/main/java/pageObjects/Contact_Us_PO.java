...
public class Contact_Us_PO extends Base_PO {
    ...
    public void setUnique_FirstName() {
        ...
        sendKeys(firstName_TextField, "AutoFN" + generateRandomString(5));
    }

    public void setUnique_LastName() {

        sendKeys(lastName_TextField, "AutoLN" + generateRandomString(5));
    }

    public void setUnique_EmailAddress() {
        sendKeys(emailAddress_TextField, "AutoEmail" + generateRandomString(10) + "@mail.com");
    }
